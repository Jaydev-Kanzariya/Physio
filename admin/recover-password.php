...
if(isset($_POST['submit'])){
    ...
    session_start();
        ...
        $result = mysqli_query($conn, "SELECT password FROM doctor_master WHERE Email='$email'");
        ...
        if($res == 1)
        {
                if($newpassword != $confirmnewpassword){
                    ...
                    $sql=mysqli_query($conn, "UPDATE doctor_master SET password='$newpassword' where Email='$email'");
                // echo "Congratulations You have successfully changed your password";
                header("Location:login.php");
            }
        }else{
            echo "<font id=p>your email entered does not exist</font>";
        }
}
?>
