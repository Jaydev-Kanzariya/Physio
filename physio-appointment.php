...
<body class="stretched"
            ...
            <div class="container">
                ...
                <div class="row justify-content-between">
                    <div class="col-12 col-md-auto d-none d-md-flex">
                        ...
                        <div class="top-links">
                            <ul class="top-links-container">
                                ...
                                <li class="top-links-item"><a href="#"><i class="bi-telephone"></i> +1-800-9876-221</a>
                                </li>
                                <li class="top-links-item"><a href="#" class="text-transform-none"><i
                                            class="bi-envelope"></i> medical@canvas.com</a></li>
                            </ul>
                        </div><!-- .top-links end -->
                    ...
                    <div class="col-12 col-md-auto">
                        ...
                        <div class="top-links">
                            <ul class="top-links-container">
                                <li class="top-links-item"><a href="physio-appointment.html"
                    ...
                    <div class="header-row">
                        ...
                        <div id="logo">
                            <img class="logo-default"
                                srcset="demos/medical/images/logo-medical.png, demos/medical/images/logo-medical@2x.png 2x"
                                src="demos/medical/images/logo-medical@2x.png" alt="Canvas Logo">
                        </div><!-- #logo end -->
                        ...
                        <nav class="primary-menu style-3 menu-spacing-margin">
                            ...
                            <ul class="menu-container">
                                <li class="menu-item"><a class="menu-link" href="physio-home.html">
                                        <div>Home</div>
                                    </a></li>
                                <li class="menu-item current"><a class="menu-link" href="physio-appointment.html">
                                        <div>Appointment</div>
                                    </a></li>
                                <li class="menu-item"><a class="menu-link" href="physio-about.html">
                                        <div>About Us</div>
                                    </a></li>
                                <li class="menu-item"><a class="menu-link" href="physio-contact.html">
                                        <div>Contact</div>
                                    </a></li>
                            </ul>
                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                <div class="d-none d-lg-block" style="position: relative;" data-height-xl="413">
                                    <img src="demos/medical/images/appointment/doctor1.png" alt="Image"
                            ...
                            <div class="form-widget col-lg-7">
                                ...
                                <form class="row mb-0" action="appointment_process.php" method="post">
                                    ...
                                    <div class="col-md-8 form-group">
                                        ...
                                        $result = mysqli_query($conn, $qry);
                                            ?>
                                        <select class="form-control not-dark required" name ="DoctorName">
                                            <?php
                                    ...
                                    <div class="col-4 form-group">
                                        <label for="gender">Gendre&nbsp;</label>&nbsp;<br>
                                        <label class="me-4">
                                            <input type="radio" id="booking" name="gender" value="Male" checked>
                                            Male
                                        </label>
                                        <label>
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="date" id="template-medical-dob" name="dob"
                                            class="form-control not-dark required">
                                    </div>
                                    <div class="w-100"></div>
                                    <div class="col-md-5">
                                        <div class="row">
                                            <div class="col-12 form-group">
                                                ...
                                                <input type="datetime-local" id="template-medical-appoint-date"
                                                    name="datetime" class="form-control not-dark required">
                                            </div>
                                    ...
                                    <div class="col-md-7 form-group">
                                        ...
                                        <textarea id="template-medical-message" name="message"
                                            class="form-control not-dark" cols="30" rows="5"></textarea>
                                    </div>
                                    <div class="w-100"></div>
                                    ...
                                    <div class="col-12 form-group text-end">
                                        <!-- <button type="submit" class="button m-0" name="submit">Confirm
                                            Booking</button> -->
                                        <button type="submit" class="button m-0" name="submit">Confirm Booking</button>
                                    </div>
                                </form>
                ...
                <div class="section m-0">
                    <div class="container">
                        <div class="heading-block text-center border-bottom-0 mb-6">
                            ...
                            <span>Dynamically formulate error-free results before integrated results. Dramatically
                                incubate integrated resources without cost effective "outside the.</span>
                        </div>
                        <div id="faqs" class="faqs row">
                            <div class="col-lg-6">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Explicabo, placeat,
                                    ...
                                    aliquam ipsa alias assumenda officiis quasi sapiente suscipit veniam odio
                                    ...
                                    repudiandae expedita omnis molestiae alias repellat perferendis dolores dolor.</p>
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus, fugiat iste nisi
                                    ...
                                    saepe animi recusandae. Asperiores, provident, esse, doloremque, adipisci eaque
                                    alias dolore molestias assumenda quasi saepe nisi ab illo ex nesciunt nobis
                                    laboriosam iusto quia nulla ad voluptatibus iste beatae voluptas corrupti facilis
                            ...
                            <div class="col-lg-6">
                                ...
                                <h4><strong class="color">Q.</strong> What Images, Videos, Code or Music Can I Use in my
                                    Items?</h4>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad odio ab quis architecto
                                    recusandae doloremque incidunt! Eius, quidem, pariatur necessitatibus commodi
                                    aliquid deleniti repudiandae accusantium nemo voluptate ullam natus illum magnam
                                    alias nobis doloremque delectus ipsa dicta repellat maxime dignissimos eveniet quae
                                    debitis ratione assumenda tempore officiis fugiat dolor. Saepe iusto praesentium
                                    ullam aliquam impedit.</p>

                                <div class="line line-sm"></div>

                                <h4><strong class="color">Q.</strong> Can I use trademarked names in my items?</h4>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eveniet, nisi, laborum
                                    autem reprehenderit excepturi harum ipsum quod sit. Inventore et sunt nemo natus
                                    labore voluptate omnis reprehenderit culpa. Minus vitae molestiae totam ut a
                                    accusamus at fugiat nemo debitis delectus? Consectetur, deleniti, cupiditate ad
                                    doloribus numquam minus illum fugit laborum a voluptatum nulla at autem ab beatae
                                    odio dolorem assumenda magni laudantium saepe recusandae doloremque illo nesciunt
                                    aut quos debitis neque reiciendis veritatis iusto eos aliquid voluptatem pariatur
                                    eveniet velit?</p>
                                ...
                                <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quo iusto
                                    aliquam voluptatem? Reiciendis, beatae, ipsam delectus voluptas ea error voluptates
                                    labore corporis ad tenetur sunt temporibus aperiam sit quis quasi tempora enim quo
                                    numquam provident ullam velit cumque similique veritatis quidem aliquam voluptatibus
                                    atque fugiat recusandae accusamus praesentium aut ipsa.</p>
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-12 col-lg">
                                ...
                                <span class="text-transform-none">We strive to provide Our Customers with Top Notch
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="widget">
                                ...
                                <form id="widget-subscribe-form" action="include/subscribe.php" method="post"
                                    ...
                                    <div class="col-lg-3">
                                        <button class="button button-rounded m-0 text-center w-100"
                            ...
                            <div class="widget subscribe-widget">
                                ...
                                <div class="row col-mb-30">
                                    ...
                                    <div class="col-sm-6 col-md-12 col-lg-6">
                                        ...
                                        <a href="#"><small class="d-block"><strong>Subscribe</strong><br>to RSS
                                                Feeds</small></a>
                                    </div>
                                </div>
    ...
    <script src="js/state_district.js"></script>
